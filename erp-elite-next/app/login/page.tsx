...
export default function LoginPage() {
    ...
    return (
        <div className="min-h-screen bg-gradient-to-r from-black via-yellow-600 to-yellow-400 flex flex-col sm:justify-center items-center pt-6 sm:pt-0">
            ...
            {/* Logo Slot Placeholder if needed */}
            {/* <div>
          <a href="/">
            ...
            <div className="w-full sm:max-w-md mt-6 px-6 py-4 bg-black/30 backdrop-blur-md shadow-md overflow-hidden sm:rounded-lg">
                <div>
                    <h3 className="text-white font-semibold text-2xl text-center mb-4">Iniciar Sesión</h3>
                        ...
                        <div className="block mt-4">
                            <label htmlFor="remember_me" className="flex items-center">
                                <input
                                    id="remember_me"
                                    type="checkbox"
                                    className="rounded text-yellow-500 shadow-sm focus:border-yellow-300 focus:ring focus:ring-yellow-200 focus:ring-opacity-50"
                                    name="remember"
                                    checked={remember}
                                    onChange={(e) => setRemember(e.target.checked)}
                                />
                                <span className="ms-2 text-sm text-gray-300">Recordarme</span>
                            </label>
                        </div>

                        <div className="flex flex-col items-center justify-center mt-4 space-y-2">
                            {/* <Link
                                href="/password-reset" // Placeholder route
