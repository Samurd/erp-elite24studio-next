...
const formSchema = z.object({
    ...
    code: z.string().optional(), // Server generated or read-only
...
export default function ClientForm({ invoice, isEditing = false, onSuccess, onCancel, hideTitle = false }: ClientFormProps) {
    ...
    const { data: options } = useQuery({
        queryKey: ["invoices-clients-options"],
        queryFn: async () => {
            const res = await fetch("/api/finances/invoices/clients/options");
    ...
    const createMutation = useMutation({
        mutationFn: async (values: z.infer<typeof formSchema>) => {
            const res = await fetch("/api/finances/invoices/clients", {
                method: "POST",
        ...
        onSuccess: () => {
            ...
            if (onSuccess) {
                ...
                router.push("/finances/invoices/clients");
                router.refresh();
            }
        },
        onError: (error: Error) => {
    ...
    const updateMutation = useMutation({
        mutationFn: async (values: z.infer<typeof formSchema>) => {
            const res = await fetch(`/api/finances/invoices/clients/${invoice.id}`, {
                method: "PUT",
                headers: { "Content-Type": "application/json" },
                body: JSON.stringify(values),
            });
