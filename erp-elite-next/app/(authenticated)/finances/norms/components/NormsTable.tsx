...
import { Pencil, Trash2, Eye, Paperclip, ChevronLeft, ChevronRight } from "lucide-react"
...
export function NormsTable({ data, meta, onPageChange, onEdit, onDelete, onView, isLoading }: NormsTableProps) {
    if (isLoading) {
        return <div className="text-center py-10">Cargando normas...</div>
    }
                ...
                <Table>
                    <TableHeader className="bg-gradient-to-r from-black to-yellow-600">
                        <TableRow className="border-none hover:bg-transparent">
                            ...
                            <TableHead className="text-white font-semibold uppercase">Nombre</TableHead>
                            <TableHead className="text-white font-semibold uppercase text-center">Archivos</TableHead>
                            ...
                            <TableRow key={item.id} className="border-b border-gray-100 hover:bg-gray-50 text-gray-800">
                                ...
                                <TableCell className="text-center p-2">
                                    <div className="flex items-center justify-center gap-1 text-gray-600">
                                        ...
                                        <span className="text-xs">{item.files?.length || 0}</span>
                                    </div>
                                </TableCell>
